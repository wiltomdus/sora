...
FLIGHT_STAGES = ("LAUNCHPAD", "POWERED_ASCENT", "COASTING_ASCENT", "APOGEE", "DESCENT", "LANDED")
...
class FlightManager:
    ...
    async def fly(self, event, is_development) -> None:
        ...
        while event.is_set():
            ...
            if not is_development:
                ...
                self.log_flight_data(altitude, pressure, temperature, self.accel_x, self.accel_y, self.accel_z, velocity_x, velocity_y, velocity_z, self.flight_stage)
            
            else:
                print(f"{time.monotonic()},{altitude:.2f},{pressure:.2f},{temperature:.2f},{velocity_x:.4f},{velocity_y:.4f},{velocity_z:.4f},{self.accel_x:.4f},{self.accel_y:.4f},{self.accel_z:.4f},{self.flight_stage}")
    ...
    def get_max_values(self):
        ...
        return self.max_altitude - self.initial_altitude, self.max_velocity_y, self.max_acceleration_y
